...
use Rutatiina\SalesOrder\Models\SalesOrderLedger;
use Rutatiina\SalesOrder\Traits\Init as TxnTraitsInit;
use Rutatiina\SalesOrder\Traits\Inventory as TxnTraitsInventory;
use Rutatiina\SalesOrder\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = SalesOrder::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
