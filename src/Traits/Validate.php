...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $this->settings = SalesOrderSetting::with(['financial_account_to_debit', 'financial_account_to_credit'])->first();
        ...
        $last_txn = SalesOrder::latest()->first();
        ...
        //the code bellow is commented out because the items of a sales order cannot be arranged in journal format
